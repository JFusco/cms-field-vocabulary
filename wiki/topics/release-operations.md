...
- npm trusts the `JFusco/cms-field-vocabulary` `release.yml` workflow through OIDC. The bootstrap `NPM_TOKEN` secret has been deleted and is no longer referenced by the workflow.
